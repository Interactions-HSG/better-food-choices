...
if (document.getElementsByClassName('filter-list js-boolean-filters').length!=0) 
document.getElementsByClassName("filter-list js-boolean-filters")[0].remove();
if (document.getElementsByClassName('filter-list-checkbox-label mui-form-label mui-form-checkbox-label js-boolean-facet-toggle facet-toggle ').length!=0) 
document.getElementsByClassName("filter-list-checkbox-label mui-form-label mui-form-checkbox-label js-boolean-facet-toggle facet-toggle ")[0].remove();
...
if (document.getElementsByClassName('optiRealPersonStatusbutton optiRealPersonStatusbuttonHRight optiRealPersonStatusbuttonVCenter').length!=0)
document.getElementsByClassName("optiRealPersonStatusbutton optiRealPersonStatusbuttonHRight optiRealPersonStatusbuttonVCenter")[0].remove();
...
// remove rating options

function removeOption() {
	return $('select').children().each((index, value) => {
		var t = $.trim($(value).text());

		if (t === "Rating absteigend") {
			$(value).remove();
		}
		if (t === "Preis aufsteigend") {
			$(value).remove();
		}
		if (t === "Preis absteigend") {
			$(value).remove();
		}

	});

  	//return $('select option[value="' + i + '"]').remove();
}


removeOption();

setInterval(removeOption, 1000);
